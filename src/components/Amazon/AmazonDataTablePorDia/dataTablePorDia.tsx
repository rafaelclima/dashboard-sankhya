...
import { FilterMenu } from '@/components/Amazon/AmazonFilterMenu'
import { Button } from '@/components/ui/button'
import type { dadosArquivoAmazon } from '@/types/amazon.types'

interface DataTableProps {
  columns: ColumnDef<dadosArquivoAmazon, unknown>[]
  data: dadosArquivoAmazon[]
  isError: boolean
}
                ...
                {table.getFooterGroups().map((footerGroup) => (
                  <TableRow
                    ...
                    {footerGroup.headers.map((header) => {
                      const isValueColumn = header.column.id === 'VALOR_TRANSACAO'
                      return (
                        <TableHead
                          key={header.id}
