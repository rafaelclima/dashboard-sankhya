...
import type { DadosDoGraficoKabum, dadosArquivoKabum } from '@/types/kabum.types'
import React from 'react'
import { Bar, BarChart, CartesianGrid, LabelList, XAxis } from 'recharts'
import { columns } from '../KabumDataTablePorArquivo/columnsPorArquivo'
import { KabumModalComponentPorArquivo } from '../Modal/KabumModalPorArquivo'

interface dataChartProps {
  dataChart: DadosDoGraficoKabum[]
...
export function GraficoPorArquivo({
  ...
  const quantidadePendentes = tableData.filter(
